...
ActiveRecord::Schema.define(version: 20180413023801) do
  ...
  create_table "geems", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.bigint "user_id"
    t.string "name"
    t.string "use_for"
    t.string "url"
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["user_id"], name: "index_geems_on_user_id"
  end
